...
export const GlobalStyle = createGlobalStyle`:root {
	...
	--color-secundary: #2F4858;
	--color-secundary-lg: #0090B0;

	--color-error: #CC6032;
	--color-accent: #535A94;

	--color-gray: #99B0A7;
	--color-gray-lg: #f1f4f3;
	--color-gray-dk: #384842;
	--color-black: #020907;
	--color-white: #ffffff;
	...
	--svg-color-white: invert(100%) sepia(0%) saturate(7447%) hue-rotate(77deg) brightness(106%) contrast(101%);
